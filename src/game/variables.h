...
MACRO_CONFIG_INT(ClMultiViewDebug, cl_multi_view_debug, 0, 0, 1, CFGFLAG_CLIENT, "Showing debug informations")
MACRO_CONFIG_INT(ClMultiViewZoomSmoothness, cl_multi_view_zoom_smoothness, 1300, 0, 5000, CFGFLAG_CLIENT, "Set the smoothness of the multi view zoom")
MACRO_CONFIG_INT(ClMultiViewMultiplierBoost, cl_multi_view_multiplier, 1, 0, 100, CFGFLAG_CLIENT, "Set the speed of the camera handler")
